...
def build_segment_results() -> dict[str, dict[str, list[SegmentResult]]]:
    ...
    r1 = SegmentResult(
        ...
        attempts=2,
        fastest_time=100.0,
        fastest_date=pd.Timestamp("2025-01-01"),
    )
    r2 = SegmentResult(
        runner="B",
        team="Blue",
        ...
        attempts=1,
        fastest_time=95.0,
        fastest_date=pd.Timestamp("2025-01-02"),
    )
...
def test_distance_sheet_column_order_and_empty(
            ...
            [
                {
                    ...
                    "Total Elev Gain (m)": 120.0,
                },
                {
                    "Runner": "B",
                    "Team": "Blue",
                    "Runs": 2,
                    "Total Distance (km)": 10.0,
                    "Total Elev Gain (m)": 90.0,
                },
            ],
        ),
    ...
    write_results(
        out_file, build_segment_results(), distance_windows_results=distance_results
    )
